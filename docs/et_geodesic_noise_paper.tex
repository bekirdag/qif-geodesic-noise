...
Instead, we provide (i) a concise conceptual sketch, and (ii) links to the complete CPU and CUDA/GPU implementations.

\medskip
\noindent\textbf{Code links:}
\begin{itemize}[leftmargin=1.5em]
\item CPU reference implementation (Python): \url{https://github.com/bekirdag/qif-geodesic-noise/blob/main/qif_v2.py}
\item CUDA/GPU accelerated implementation: \url{https://github.com/bekirdag/qif-geodesic-noise/blob/main/qif_v2_cuda.py}
\end{itemize}
